  ...
  _render() {
    this.innerHTML = `
          ...
          <div class="jumbotron pt-5 mt-5">
            ...
            <div class="col-lg-4">
                <h1 class="jumbotron__title">Komiksun</h1>
                <h1 class="jumbotron__title">(self publishing comic)</h1>
                <p class="jumbotron__tagline">Nikmati pengalaman membaca dan mempublis karya komik anda, hanya disisi!!!</p>
            </div>
            <div class="col-lg-5">
